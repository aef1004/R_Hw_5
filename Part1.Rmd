...
TX_tracts <- tracts("Texas", county = c("Harris County", "Brazoria", "Fort Bend", "Montgomery", "Liberty", "Waller"), cb = TRUE) 
TX_tracts <- st_as_sf(TX_tracts)
Houston_water <- area_water("Texas", county = c("Harris County", "Brazoria", "Fort Bend", "Montgomery", "Liberty", "Waller"))
